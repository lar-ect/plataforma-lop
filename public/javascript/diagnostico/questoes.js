...
class App extends Component {
  ...
  rodarDiagnostico = () => {
    ...
    axios
      .get('/api/v1/executar-diagnostico-questoes')
      .then(res => {
      ...
      <div>
        <div className="has-text-centered m-b-16">
          <button
            ...
            type="button"
            onClick={this.rodarDiagnostico}>
            Rodar diagnóstico
          </button>
        </div>
        <div className="container is-fluid">
          <CardsEstadoQuestoes questoes={this.state.resultadoQuestoes} />
        </div>
      </div>
    );
  }
...
ReactDOM.render(<App />, document.getElementById('diagnostico-container'));
