...
router.get(
  ...
  listaExercicioController.adicionarLista
);
...
router.get(
  ...
  authController.isLoggedIn,
  authController.temPermissao('CREATE_QUESTAO'),
  catchErrors(listaExercicioController.editar)
);
...
router.post(
  ...
  authController.isLoggedIn,
  authController.temPermissao('CREATE_QUESTAO'),
  catchErrors(listaExercicioController.criarLista)
);
...
router.post(
  ...
  authController.isLoggedIn,
  authController.temPermissao('CREATE_QUESTAO'),
  catchErrors(listaExercicioController.atualizarLista)
);
